		...
		return new Promise((resolve, reject) => {
			if (this.successEvent !== undefined || this.failEvent !== undefined) {
				const callback = (e) => {
					...
					if (this.successEvent === 'VKWebAppOpenQRResult' && (eventType === 'VKWebAppOpenQRResult' ||
						eventType === 'VKWebAppQRDone')) {
						onFind(data, true)
					} else if (this.successEvent !== undefined && this.successEvent === eventType) {
